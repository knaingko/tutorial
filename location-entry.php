...
<?php
    ...
    $locationID = $locationName = $month = $countryID = $cityID = $errorMsg= ''; $countryData = $cityData = $data = array();
    ...
    if(!empty($_POST))
    {
        ...
        $checkData = GetDataByKey('./data/location.csv','LocationID',$locationID);
        if($checkData['LocationID']==$locationID)
        {
            $errorMsg = 'This Location already exists in file!';
        }else{
            $_savedata = array(
...
<section id="country-entry" class="container" style="height:793px;">
    <div  class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">Location Entry Form</h3>
        </div>
        <div class="panel-body" align="center">
            <form id="LocationForm" name="LocationForm" role="form" class="form-horizontal">
                <div class="form-group">
                    <div class="input-group col-sm-3 form-inline">
                        <label for="location_id" class="input-group-addon">ID</label>
                        <input type="text" id="location_id" name="location_id" placeholder="Location ID" class="form-control" value="<?php echo($locationID); ?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="input-group col-sm-3">
                        ...
                        <select id="country_id" name="country_id" class="form-control">
                            <?php echo(html_option("CountryID","CountryName",$countryData));?>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group col-sm-3">
                        ...
                        <select id="city_id" name="city_id" class="form-control">
                            <?php echo(html_option("CityID","CityName",$cityData));?>
                        </select>
                    </div>
                </div>
                <br/>
